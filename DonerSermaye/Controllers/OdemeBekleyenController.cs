...
{
    public class OdemeBekleyenController : Controller
    {
        private readonly donersermayeContext _context;

        public OdemeBekleyenController(donersermayeContext context)
        {
            _context = context;
        }
        ...
        {
            var donersermayeContext = _context.Isler.Include(i => i.Bolum).Include(i => i.Firma).Include(i => i.Tur).Where(i=>i.Durum==0 && i.HesapId==null && i.FaturaTipi==2);
        ...
        public async  Task<IActionResult> HesapEkle(string hesap)
        {
            ...
            _context.SaveChanges();
            var guncelle =  _context.Isler.Where(i => i.Durum == 1 && i.Lab != 1 && i.HesapId == null && i.FaturaTipi == 1);
