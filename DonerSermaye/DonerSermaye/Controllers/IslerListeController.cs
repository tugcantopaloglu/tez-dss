...
{
    public class IslerListeController : Controller
    {
        private readonly donersermayeContext _context;

        public IslerListeController(donersermayeContext context)
        {
            _context = context;
        }

        // GET: Isler
        public IActionResult Index(int? FirmaId, int? BolumId, DateTime? BaslamaTarihi, DateTime? BitisTarihi, int? IsNo, int faturasigirilmeyenlerdahil)
        {
            ...
            */
            ...
            else
            {
                ...
                if (BaslamaTarihi != null)
                {
                    ...
                    if (faturasigirilmeyenlerdahil == 0)
