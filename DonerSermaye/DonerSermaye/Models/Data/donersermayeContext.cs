...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                //optionsBuilder.UseSqlServer("Server=WIN-CM76AJE4CGS;Database=ds2;Integrated Security=True;");
                /*
                 optionsBuilder.UseSqlServer("Server=WIN-CM76AJE4CGS;User Id=muhuser;password=577mh577;Database=ds3;", builder =>
                {
                    builder.EnableRetryOnFailure(5, TimeSpan.FromSeconds(10), null);
                });
                */
                optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=DS3;Integrated Security=True;", builder =>
                {
                    builder.EnableRetryOnFailure(5, TimeSpan.FromSeconds(10), null);
                });
